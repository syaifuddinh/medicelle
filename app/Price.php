...
class Price extends Model
{
    ...
    protected $fillable = ['grup_nota_id', 'destination', 'polyclinic_id', 'is_registration', 'is_sewa_ruangan','is_sewa_alkes', 'qty', 'percentage', 'radiology_group', 'laboratory_group'];
