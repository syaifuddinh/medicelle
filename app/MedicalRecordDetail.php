...
class MedicalRecordDetail extends Model
{
    ...
    protected $fillable = ['medical_record_id', 'disease_id', 'disease_name', 'name', 'duration', 'cure', 'last_checkup_date','description', 'pain_type', 'is_other_pain_type', 'pain_location', 'pain_duration', 'emergence_time', 'side_effect', 'is_allergy_history', 'is_disease_history', 'is_family_disease_history', 'is_pain_history', 'is_pain_cure_history', 'is_unknown', 'is_kid_history','is_pregnant_week_age','kid_order','partus_year','partus_location','pregnant_month_age','pregnant_week_age','birth_type','birth_helper','birth_obstacle','weight','long','komplikasi_nifas', 'baby_gender', 'is_imunisasi_history','is_other_imunisasi','is_imunisasi_month_age','imunisasi_month_age','imunisasi_year_age','imunisasi','reaksi_imunisasi', 'is_ginekologi_history', 'is_other_ginekologi', 'is_obgyn_disease_history', 'is_obgyn_family_disease_history', 'is_kb_history', 'is_komplikasi_kb_history', 'is_diagnose_history', 'is_children_diagnose_history', 'type', 'description', 'is_other', 'is_drug', 'is_bhp', 'is_treatment', 'is_treatment_group', 'is_diagnostic', 'item_id', 'qty', 'reduksi', 'date', 'result_date', 'signa1', 'signa2', 'lokasi_id', 'kanan', 'kiri', 'kesimpulan', 'saran', 'additional', 'assesment_detail_id', 'is_sewa_instrumen', 'is_sewa_alkes', 'is_sewa_ruangan', 'stock_id'
    ];
    ...
    public function children_diagnose_history() {
        return $this->whereIsChildrenDiagnoseHistory(1);
    }
    ...
    public function sewa_instrumen() {
        return $this->whereIsSewaInstrumen(1);
    }
