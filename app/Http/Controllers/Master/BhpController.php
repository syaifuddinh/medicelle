...
class BhpController extends Controller
{
    ...
    {
        $item = Item::bhp()->has('category')->with('category:id,name')->select('id', 'code', 'name', 'category_id')->get();
        return Response::json($item, 200);
    }

    public function actived()
    {
        $item = Item::bhp()->has('category')->with('category:id,name')->whereIsActive(1)->select('id', 'code', 'name', 'category_id')->get();
        return Response::json($item, 200);
    }
    ...
    {
        $x = Item::with('bhp_category:id,name,code', 'price:item_id,grup_nota_id', 'price.grup_nota:id,slug,name', 'piece:id,name')->find($id);
