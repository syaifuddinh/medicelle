...
class CashierApiController extends Controller
{
    public function cashier(Request $request) {
        $x = Invoice::with('registration:id,code,medical_record_id,date,patient_id', 'registration.medical_record:id,registration_id,code', 'registration.patient:id,name')->select('invoices.id', 'invoices.code', 'registration_id', 'invoices.status', 'invoices.date')
