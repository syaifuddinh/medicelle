app.controller('assesmentShow', ['$scope', '$http', '$rootScope', '$filter', '$compile', function($scope, $http, $rootScope, $filter, $compile) {
    $scope.title = 'Detail Assesment';
    $scope.data = {}
  ...
  $scope.reset()
    ...
    $scope.submitForm=function() {
      if($scope.back == 1) {
            ...
            setTimeout(function () {
              window.location = baseUrl + '/assesment/step/' + (step - 1) + '/show/' + id          
            }, 1000)
        } else {
            setTimeout(function () {
              window.location = baseUrl + '/assesment/step/' + (step + 1) + '/show/' + id          
