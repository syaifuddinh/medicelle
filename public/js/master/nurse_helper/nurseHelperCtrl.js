  ...
  oTable = $('#listview').DataTable({
    ...
    columns:[
      ...
      },
      {
        ...
        "<a class='btn btn-xs btn-success' href='" + baseUrl + "/nurse_helper/edit/" + resp.id +  "' title='Edit'><i class='fa fa-pencil'></i></a><a class='btn btn-xs btn-default' href='" + baseUrl + "/nurse_helper/" + resp.id +  "' title='Detail'><i class='fa fa-file-text-o'></i></a></div>"
      },
    ],
