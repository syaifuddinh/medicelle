app.controller('radiologyShow', ['$scope', '$http', '$rootScope', '$filter', function($scope, $http, $rootScope) {
    $scope.title = 'Detail Item Pemeriksaan Radiologi';
    $scope.formData = {}
    $scope.data = {}
    ...
    $scope.category = function() {
        $http.get(baseUrl + '/controller/master/radiology/category').then(function(data) {
