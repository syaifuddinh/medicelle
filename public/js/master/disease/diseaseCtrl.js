  ...
  oTable = $('#listview').DataTable({
    ...
    columns:[
      ...
      },
      {
        ...
        "<a class='btn btn-xs btn-success' href='" + baseUrl + "/disease/edit/" + resp.id +  "' allow_edit_disease title='Edit'><i class='fa fa-pencil'></i></a><a allow_show_disease class='btn btn-xs btn-default' href='" + baseUrl + "/disease/" + resp.id +  "' title='Detail'><i class='fa fa-file-text-o'></i></a></div>"
      },
    ],
