app.controller('administrationShow', ['$scope', '$http', '$rootScope', function($scope, $http, $rootScope) {
    $scope.title = 'Detail Administrasi & Item Tindakan';
    $scope.formData = {}
    $scope.data = {}
    ...
    $scope.category = function() {
        $http.get(baseUrl + '/controller/master/administration/category').then(function(data) {
