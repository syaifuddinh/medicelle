app.controller('laboratory', ['$scope', '$compile', '$http', function($scope, $compile, $http) {
  $scope.formData = {}
  oTable = $('#listview').DataTable({
    ...
    dom: 'Blfrtip',
    ajax: {
      url : baseUrl+'/datatable/master/laboratory',
    ...
    columns:[
      ...
      {data:"laboratory_category.name", name:"laboratory_category.name"},
      ...
      },
      {
        ...
        "<a class='btn btn-xs btn-success' href='" + baseUrl + "/laboratory/edit/" + resp.id +  "' title='Edit'><i class='fa fa-pencil'></i></a><a class='btn btn-xs btn-default' href='" + baseUrl + "/laboratory/" + resp.id +  "' title='Detail'><i class='fa fa-file-text-o'></i></a></div>"
      },
    ],
