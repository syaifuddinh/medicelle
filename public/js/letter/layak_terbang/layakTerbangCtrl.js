app.controller('layakTerbang', ['$scope', '$compile', '$http', function($scope, $compile, $http) {
    ...
    buttons: [
      {
        ...
        'filename' : 'Surat Layak Terbang - '+new Date(),
        'sheetName' : 'Data',
        'title' : 'Surat Layak Terbang'
      },
    ],
    ...
    columns:[
      {
        data:null, 
        name:"code",
        render : resp => "<a class='font-weight-bold' href='" + baseUrl + "/surat/layak_terbang/" + resp.id +  "'>" + resp.code + "</a>"
      },
  ...
  $scope.delete = function(e) {
    ...
    if(is_delete)
        ...
        id = data.id
        $http.delete(baseUrl + '/controller/letter/layak_terbang/' + id).then(function(data) {
            oTable.ajax.reload();
