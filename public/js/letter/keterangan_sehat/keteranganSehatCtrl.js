app.controller('keteranganSehat', ['$scope', '$compile', '$http', function($scope, $compile, $http) {
    ...
    buttons: [
      {
        ...
        'filename' : 'Surat Keterangan Sehat - '+new Date(),
        'sheetName' : 'Data',
  ...
  $scope.delete = function(e) {
    ...
    if(is_delete)
        ...
        id = data.id
        $http.delete(baseUrl + '/controller/letter/keterangan_sehat/' + id).then(function(data) {
            oTable.ajax.reload();
