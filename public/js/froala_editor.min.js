...
!(function (e, t) {
    ...
    (V.RegisterPlugins = function (e) {
        ...
        Object.assign(V, { DEFAULTS: { initOnClick: !1, pluginsEnabled: null }, MODULES: {}, PLUGINS: {}, VERSION: "3.2.6", INSTANCES: [], OPTS_MAPPING: {}, SHARED: {}, ID: 0 }),
    ...
    (V.LinkRegExCommon = "[".concat("a-z\\u0080-\\u009f\\u00a1-\\uffff0-9-_\\.", "]{1,}")),
            ...
            function c(e) {
                ...
                if ((l.selection.isCollapsed() && "" === l.html.get() && l.html.set(V.MARKERS), !l.core.hasFocus() && e)) {
                    ...
                    if (
                        ...
                        0 == l.browser.msie && (p(), l.el.focus(), l.events.trigger("focus"), f()),
        ...
        (V.MODULES.cursor = function (h) {
                ...
                return (
                    ...
                    (!!h.node.isBlock(e) ||
                        (e.nextSibling && e.nextSibling.nodeType === Node.TEXT_NODE && 0 === e.nextSibling.textContent.replace(/\u200b/g, "").length
                            ? d(e.nextSibling)
                            : !(e.nextSibling && (!e.previousSibling || "BR" !== e.nextSibling.tagName || e.nextSibling.nextSibling)) && d(e.parentNode)))
                );
            }
            function f(e) {
                return (
                    ...
                    (!!h.node.isBlock(e) ||
                        (e.previousSibling && e.previousSibling.nodeType === Node.TEXT_NODE && 0 === e.previousSibling.textContent.replace(/\u200b/g, "").length
                            ? f(e.previousSibling)
                            : !e.previousSibling && (!(e.previousSibling || !h.node.hasClass(e.parentNode, "fr-inner")) || f(e.parentNode))))
                );
            }
            function u(e, t) {
                return (
                ...
                if ((!h.node.isBlock(n) || (n.lastChild && o && 0 <= r.indexOf(o))) && h.node.isEditable(n)) {
                    ...
                    if (n.nodeType === Node.TEXT_NODE) {
                        ...
                        if (h.opts.tabSpaces && i.length >= h.opts.tabSpaces)
                            0 ===
                                i
                                    ...
                                    .replace(/ /g, "")
                                    .replace(new RegExp(V.UNICODE_NBSP, "g"), "").length && (a = i.length - h.opts.tabSpaces + 1);
                        (n.textContent = i.substring(0, a - C(i))),
                            h.opts.htmlUntouched && !e.nextSibling && n.textContent.length && " " === n.textContent[n.textContent.length - 1] && (n.textContent = n.textContent.substring(0, n.textContent.length - 1) + V.UNICODE_NBSP);
                        ...
                        h.node.isDeletable(n)
                            ...
                            : e.nextSibling && "BR" === e.nextSibling.tagName && h.node.isVoid(n) && "BR" !== n.tagName
                            ? (g(e.nextSibling).remove(), g(e).replaceWith(V.MARKERS))
                            : !1 !== h.events.trigger("node.remove", [g(n)]) && (g(n).after(V.MARKERS), g(n).remove());
                    ...
                    if (h.node.isDeletable(n)) g(e).replaceWith(V.MARKERS), g(n).remove();
                        ...
                        for (
                            h.node.isList(n) && (n = g(n).find("li").last().get(0)), (t = h.node.contents(n)) && "BR" === t[t.length - 1].tagName && g(t[t.length - 1]).remove(), t = h.node.contents(n);
                        ...
                        if (h.node.isDeletable(i)) g(i).remove(), g(e).replaceWith(V.MARKERS);
                            ...
                            if (h.node.isList(i))
                                if (h.node.isEmpty(n, !0)) g(n).remove(), g(i).find("li").first().prepend(V.MARKERS);
                                    ...
                                    "BLOCKQUOTE" === n.tagName && (o = h.node.contents(n)).length && h.node.isBlock(o[o.length - 1]) && (n = o[o.length - 1]),
                                ...
                                else if ("BLOCKQUOTE" === i.tagName && "BLOCKQUOTE" !== n.tagName) for (o = h.node.contents(i); o.length && h.node.isBlock(o[0]); ) (i = o[0]), (o = h.node.contents(i));
            ...
            function n(e) {
                ...
                if (!h.node.isBlock(n) && h.node.isEditable(n)) {
                    ...
                    n.nodeType === Node.TEXT_NODE
                        ? (g(n).before(V.MARKERS), n.textContent.length && (n.textContent = n.textContent.substring(C(n.textContent, !0), n.textContent.length)))
                        : h.node.isDeletable(n)
                        ? (g(n).before(V.MARKERS), g(n).remove())
                        : !1 !== h.events.trigger("node.remove", [g(n)]) && (g(n).before(V.MARKERS), g(n).remove()),
                        g(e).remove();
                } else if (V.NO_DELETE_TAGS.indexOf(n.tagName) < 0 && (h.node.isEditable(n) || h.node.isDeletable(n)))
                    if (h.node.isDeletable(n)) g(e).replaceWith(V.MARKERS), g(n).remove();
            ...
            function b(e, t, n) {
                ...
                if (o && "BLOCKQUOTE" === o.tagName)
                    return (
                        m(e, o)
                            ? ((r = h.html.defaultTag()), t ? g(e).replaceWith("<br>" + V.MARKERS) : r ? g(o).after("<".concat(r, ">").concat(V.MARKERS, "<br></").concat(r, ">")) : g(o).after("".concat(V.MARKERS, "<br>")), g(e).remove())
                            : L(e, t, n),
                        !1
                    );
                if (null === o)
                    (r = h.html.defaultTag()) && h.node.isElement(e.parentNode)
                        ? g(e).replaceWith("<".concat(r, ">").concat(V.MARKERS, "<br></").concat(r, ">"))
                        : !e.previousSibling || g(e.previousSibling).is("br") || e.nextSibling
                    ...
                    (a = l + a + c + (e.parentNode === o && h.node.isBlock(o) ? "" : V.INVISIBLE_SPACE) + V.MARKERS),
                        h.node.isBlock(o) && !g(o).find("*").last().is("br") && g(o).append("<br/>"),
                        g(e).after('<span id="fr-break"></span>'),
                        g(e).remove(),
                        (o.nextSibling && !h.node.isBlock(o.nextSibling)) || h.node.isBlock(o) || g(o).after("<br>"),
                        (s = (s = !t && h.node.isBlock(o) ? h.node.openTagString(o) + g(o).html() + f : h.node.openTagString(o) + g(o).html() + h.node.closeTagString(o)).replace(/<span id="fr-break"><\/span>/g, a)),
                        g(o).replaceWith(s);
                }
            }
            function L(e, t, n) {
                ...
                if (null === r)
                    h.html.defaultTag() && e.parentNode === h.el
                        ? g(e).replaceWith("<".concat(h.html.defaultTag(), ">").concat(V.MARKERS, "<br></").concat(h.html.defaultTag(), ">"))
                        : ((e.nextSibling && !h.node.isBlock(e.nextSibling)) || g(e).after("<br>"), g(e).replaceWith("<br>".concat(V.MARKERS)));
                    ...
                    if ("BLOCKQUOTE" === r.tagName)
                        if (
                            (e.previousSibling &&
                                ...
                                (g(e.nextSibling).after(e), e.nextSibling && "BR" === e.nextSibling.tagName && g(e.nextSibling).remove()),
                            t)
                        )
                            i = a + i + V.MARKERS + s;
                        else {
            ...
            return {
                enter: function E(e) {
                    ...
                    0 < g(t).parentsUntil(h.$el, "BLOCKQUOTE").length && (r = !0),
                        ...
                        d(t)
                            ...
                            ? !p(t) || e || r
                                ? (function l(e, t, n) {
                                      ...
                                      if (null === o)
                                          (r = h.html.defaultTag()) && h.node.isElement(e.parentNode) ? g(e).replaceWith("<".concat(r, ">").concat(V.MARKERS, "<br></").concat(r, ">")) : g(e).replaceWith("<br>".concat(V.MARKERS));
                                      else {
                                          if (((r = h.html.defaultTag()), h.node.isBlock(o)))
                                              if (("PRE" === o.tagName && (t = !0), t)) g(e).remove(), g(o).prepend("<br>".concat(V.MARKERS));
                                                  ...
                                                  g(e).replaceWith("<" + h.html.defaultTag() + ">" + V.MARKERS + "<br></" + h.html.defaultTag() + ">");
                                              else {
                        ...
                        h.opts.htmlUntouched || (h.html.cleanEmptyTags(), h.clean.lists(), h.spaces.normalizeAroundCursor()),
                        h.selection.restore();
                ...
                backspace: function s() {
                    ...
                    return (
                        d(t)
                            ? p(t) && u(t, g(t).parents("li").first().get(0))
                            ...
                            ? p(t) && u(t, g(t).parents("li").first().get(0))
                                ...
                                : (function l(e) {
                                      for (
                                          var t = 0 < g(e).parentsUntil(h.$el, "BLOCKQUOTE").length, n = h.node.deepestParent(e, [], !t), r = n;
                                          n && !n.previousSibling && "BLOCKQUOTE" !== n.tagName && n.parentElement !== h.el && !h.node.hasClass(n.parentElement, "fr-inner") && V.SIMPLE_ENTER_TAGS.indexOf(n.parentElement.tagName) < 0;
                                                  ...
                                                  if (h.node.isDeletable(a)) g(a).remove(), g(e).replaceWith(V.MARKERS);
                                                      ...
                                                      if (h.node.isBlock(a))
                                                          if (h.node.isEmpty(a) && !h.node.isList(a)) g(a).remove(), g(e).after(h.opts.keepFormatOnDelete ? V.INVISIBLE_SPACE : "");
                                                              ...
                                                              if (
                                                                  (h.node.isList(a) && (a = g(a).find("li").last().get(0)),
                                                                  (i = h.node.contents(a)).length && "BR" === i[i.length - 1].tagName && g(i[i.length - 1]).remove(),
                                                              ...
                                                              else if ("BLOCKQUOTE" !== a.tagName && "BLOCKQUOTE" === r.tagName) for (i = h.node.contents(r); i.length && h.node.isBlock(i[0]); ) (r = i[0]), (i = h.node.contents(r));
                                                          ...
                                                          g(e).replaceWith(V.MARKERS),
                                                              "BLOCKQUOTE" === n.tagName && a.nodeType === Node.ELEMENT_NODE
                                                                  ? g(a).remove()
                                                                  : (g(a).after(h.node.isEmpty(n) ? "" : g(n).html()), g(n).remove(), "BR" === a.tagName && g(a).remove());
                                              } else
                                                  a ||
                                                      (n &&
                                                      ...
                                                      0 ===
                                                          g(n)
                                                              ...
                                                              .replace(/\u200B/g, "").length
                                                          ? g(n).remove()
                                                          : h.node.isEmpty(n) && n.parentNode && h.node.isEditable(n.parentNode) && n.parentNode != h.el && g(n.parentNode).remove());
                                      }
                                  })(t)
                            : (e = v(t)),
                        g(t).remove(),
        ...
        (V.MODULES.format = function (T) {
            ...
            function x(e, t, n, r) {
                if (!r) {
                    var o = !1;
                    if (!0 === e.data("type")) for (; T.node.isFirstSibling(e.get(0)) && !e.parent().is(T.$el) && !e.parent().is("ol") && !e.parent().is("ul"); ) e.parent().before(e), (o = !0);
                    else if (!1 === e.data("type")) for (; T.node.isLastSibling(e.get(0)) && !e.parent().is(T.$el) && !e.parent().is("ol") && !e.parent().is("ul"); ) e.parent().after(e), (o = !0);
                    if (o) return !0;
                }
                if (e.parents(t).length || void 0 === t) {
                    ...
                    return (
                        ...
                        (i = l.html().replace(/<span id="mark"><\/span>/, a + T.node.closeTagString(l.get(0)) + s + c + a + T.node.openTagString(l.get(0)) + s)),
                        l.replaceWith(T.node.openTagString(l.get(0)) + i + T.node.closeTagString(l.get(0))),
                        !0
                    );
                }
                return !1;
                        ...
                        if ((a.innerHTML && 8203 == a.innerHTML.charCodeAt() && a.tagName.toLocaleLowerCase() == n && a.childNodes.length < 2 && (a.outerHTML = a.innerHTML), T.node.hasClass(a, "fr-marker"))) t = (t + 1) % 2;
                            ...
                            if (0 < M(a).find(".fr-marker").length) t = y(M(a), t, n, r);
                                ...
                                for (var s = M(a).find(n || "*:not(br)"), l = s.length - 1; 0 <= l; l--) {
                                    var c = s[l];
                                    T.node.isBlock(c) || T.node.isVoid(c) || (void 0 !== n && !A(c, N(n, r)))
                                        ? T.node.isBlock(c) && void 0 === n && "TABLE" !== a.tagName && T.node.clearAttributes(c)
                                        : T.node.hasClass(c, "fr-clone") || (c.outerHTML = c.innerHTML);
                                }
                                (void 0 === n && a.nodeType === Node.ELEMENT_NODE && !T.node.isVoid(a)) || A(a, N(n, r))
                                    ? T.node.isBlock(a) || T.node.hasClass(a, "fr-clone") || (a.outerHTML = a.innerHTML)
                                    : void 0 === n && a.nodeType === Node.ELEMENT_NODE && T.node.isBlock(a) && "TABLE" !== a.tagName && T.node.clearAttributes(a);
                            }
                        else 0 < M(a).find(".fr-marker").length && (t = y(M(a), t, n, r));
                    }
                    return t;
                })(T.$el, 0, e, t),
                    n || (T.$el.find(".fr-marker").remove(), T.$el.find(".fr-clone").removeClass("fr-clone").addClass("fr-marker")),
                ...
                if (T.selection.isCollapsed()) {
                    ...
                    if (T.node.openTagString(l.get(0)) === '<span style="'.concat(e, ": ").concat(l.css(e), ';">')) {
                        if (T.node.isEmpty(l.get(0))) (s = M(T.doc.createElement("span")).attr("style", "".concat(e, ": ").concat(t, ";")).html("".concat(V.INVISIBLE_SPACE).concat(V.MARKERS))), l.replaceWith(s);
                            ...
                            (c["style*"] = "".concat(e, ":")),
                                ...
                                t
                                    ? ((s = M(T.doc.createElement("span")).attr("style", "".concat(e, ": ").concat(t, ";")).html("".concat(V.INVISIBLE_SPACE).concat(V.MARKERS))), r.replaceWith(s))
                        ...
                        T.node.isEmpty(l.get(0)) && l.is("span")
                            ...
                            : ((s = M('<span style="'.concat(e, ": ").concat(t, ';">').concat(V.INVISIBLE_SPACE).concat(V.MARKERS, "</span>"))), r.replaceWith(s));
                    s && C(s, e, t);
                } else {
                    if ((T.selection.save(), null === t || ("color" === e && 0 < T.$el.find(".fr-marker").parents("u, a").length))) {
                        ...
                        for (n = 0; n < d.length; n++)
                            ...
                            else for (; T.node.isLastSibling(r.get(0)) && !r.parent().is(T.$el) && !T.node.isElement(r.parent().get(0)) && !T.node.isBlock(r.parent().get(0)); ) r.parent().after(r);
                    }
                    ...
                    for (
                        t && (p.style = "".concat(e, ": ").concat(t, ";")),
                            ...
                            (t || "").match(/\dem$/) && T.$el.find("span.fr-unprocessed").removeClass("fr-unprocessed");
            ...
            function C(e, t, n) {
                ...
                for (r = a.length - 1; 0 <= r; r--)
                    (o = a[r]), (i = t), 0 === M(o).attr("style").indexOf("".concat(i, ":")) || 0 <= M(o).attr("style").indexOf(";".concat(i, ":")) || 0 <= M(o).attr("style").indexOf("; ".concat(i, ":")) || s.push(a[r]);
                if ((a = a.not(s)).length) {
                    for (
                        ...
                        (p = p.parentNode),
                            ...
                            (c = T.node.openTagString(M(p).clone().addClass("fr-split").get(0)) + c),
                            a.get(0) !== p && ((d += T.node.closeTagString(p)), (f = T.node.openTagString(M(p).clone().addClass("fr-split").get(0)) + f)),
                            a.get(0) !== p;
            ...
            function r(e, t) {
                ...
                if (!c.html.isPreformatted(i)) {
                    ...
                    for (var s = "", l = 0; l < o.length; l++)
                        ...
                        (!(((c.opts.enter === V.ENTER_BR || c.opts.enter === V.ENTER_DIV) && ((n && "BR" === n.tagName) || (r && "BR" === r.tagName))) || (n && r && n.tagName === r.tagName)) &&
                            ...
                            if (!l) {
                                ...
                                (v =
                                    (E.browser.chrome || E.browser.edge) && o.nextSibling === a
                                        ? ((C = N(a, i, !0) || i.setStartAfter(a)), N(o, i, !1) || i.setEndBefore(o))
                                        : (o.previousSibling === a && (a = (o = a).nextSibling),
                                          ...
                                          (C = N(o, i, !0) || (y(o).before(s) && i.setStartBefore(o))),
                                        ...
                                        for (o = 0; o < h.length; o++) {
                                            ...
                                            for (var g = 1e3 * d + $(c[f].selectorText), m = c[f].style.cssText.split(";"), C = 0; C < m.length; C++) {
                                                ...
                                                if (
                                                    ...
                                                    g >= a[h[o]][v] && ((a[h[o]][v] = g), m[C].trim().length))
                                                ) {
        ...
        (V.MODULES.keys = function (d) {
            ...
            function h(e) {
                ["INPUT", "BUTTON", "TEXTAREA"].indexOf(e.target && e.target.tagName) < 0 && e.preventDefault(),
                    e.stopPropagation(),
                    "" !== d.selection.text() || (!d.selection.isCollapsed() && "IMG" == d.selection.element().tagName) ? d.selection.remove() : d.cursor.del(),
                    d.placeholder.refresh();
            }
            function e() {
        ...
        (V.MODULES.paste = function (N) {
            ...
            function d() {
                N.opts.iframe && N.$el.attr("contenteditable", "true"),
                    ...
                    a || ((a = i.get(0).innerHTML), (A = i.text()), N.selection.restore(), N.events.enableBlur());
                ...
                if (!t)
                    if (
                        ...
                        (N.opts.htmlAllowedStyleProps = N.opts.pasteAllowedStyleProps),
                            ...
                            (e = (e = (e = e.replace(/<span class="Apple-tab-span">\s*<\/span>/g, w(N.opts.tabSpaces || 4))).replace(/<span class="Apple-tab-span" style="white-space:pre">(\t*)<\/span>/g, function (e, t) {
        ...
        (V.MODULES.popups = function (u) {
            ...
            function n(e) {
                ...
                if (
                    ...
                    u.$tb && (1 < u.opts.zIndex ? u.$tb.css("zIndex", u.opts.zIndex + 1) : u.$tb.css("zIndex", "")),
            ...
            function c(e, t) {
                ...
                "filesManager.insert" === e
                    ? o.addClass("fr-popup fr-files-manager".concat(u.helpers.isMobile() ? " fr-mobile" : " fr-desktop").concat(u.opts.toolbarInline ? " fr-inline" : ""))
                    : o.addClass("fr-popup".concat(u.helpers.isMobile() ? " fr-mobile" : " fr-desktop").concat(u.opts.toolbarInline ? " fr-inline" : "")),
                    o.html(r),
                    u.opts.theme && o.addClass("".concat(u.opts.theme, "-theme")),
                    1 < u.opts.zIndex && (!u.opts.editInPopup && u.$tb ? u.$tb.css("z-index", u.opts.zIndex + 2) : o.css("z-index", u.opts.zIndex + 2)),
                    "auto" !== u.opts.direction && o.removeClass("fr-ltr fr-rtl").addClass("fr-".concat(u.opts.direction)),
                    o.find("input, textarea").attr("dir", u.opts.direction).attr("disabled", "disabled"),
                ...
                return {
                    ...
                    _editorKeydown: function (e) {
                        ...
                        t.keys.ctrlKey(e) ||
                            ...
                            (C(r) && o.findVisible(".fr-back").length ? t.button.exec(o.findVisible(".fr-back").first()) : e.which !== V.KEYCODE.ALT && t.popups.hide(r));
                    },
                    _preventFocus: function (e) {
                        ...
                        "mouseup" === e.type || d(n).is(":focus") || t.events.disableBlur(),
                            "mouseup" !== e.type || d(n).hasClass("fr-command") || 0 < d(n).parents(".fr-command").length || d(n).hasClass("fr-dropdown-content") || u.button.hideActiveDropdowns(o),
                            (u.browser.safari || u.browser.mozilla) && "mousedown" === e.type && d(n).is("input[type=file]") && t.events.disableBlur();
            ...
            function f(e, t) {
                u.events.on("mouseup", e._editorMouseup, !0),
                    ...
                    u.$wp && !u.helpers.isMobile() && u.events.$on(u.$wp, "scroll.popup".concat(t), e._repositionPopup),
                ...
                (u.shared.exit_flag = !1),
                {
                    ...
                    create: function S(e, t) {
                        var n = c(e, t),
                            r = E(e);
                        f(r, e),
                            u.events.$on(n, "mousedown mouseup touchstart touchend touch", "*", r._preventFocus, !0),
                            u.events.$on(n, "focus", "input, textarea, button, select", r._inputFocus, !0),
                            u.events.$on(n, "blur", "input, textarea, button, select", r._inputBlur, !0);
                    ...
                    show: function M(e, t, n, r, o) {
                        ...
                        if (
                            ...
                            u.opts.toolbarInline &&
                                ...
                                s.get(0) === u.$tb.get(0) &&
                                (m(e, u.$sc),
                                (n = u.$tb.offset().top - u.helpers.getPX(u.$tb.css("margin-top"))),
                                (t = u.$tb.offset().left + u.$tb.outerWidth() / 2),
                                u.node.hasClass(u.$tb.get(0), "fr-above") && n && (n += u.$tb.outerHeight()),
                                (r = 0)),
                        ...
                        s.is(u.$tb) ? u.$tb.css("zIndex", (u.opts.zIndex || 1) + 4) : g[e].css("zIndex", (u.opts.zIndex || 1) + 3),
                            u.opts.toolbarBottom && s && u.$tb && s.get(0) === u.$tb.get(0) && (g[e].addClass("fr-above"), n && (n -= g[e].outerHeight())),
                            o && (t -= g[e].width() / 2),
                            t + g[e].outerWidth() > u.$sc.offset().left + u.$sc.width() && (t -= t + g[e].outerWidth() - u.$sc.offset().left - u.$sc.width()),
                            t < u.$sc.offset().left && "rtl" === u.opts.direction && (t = u.$sc.offset().left),
                    ...
                    setPopupDimensions: function w(e, t) {
                        t &&
                            ...
                            (e.find(".fr-upload-progress").addClass("fr-height-auto"), u.popups.get("filesManager.insert").addClass("fr-height-auto"), e.find(".fr-upload-progress").removeClass("fr-height-set"), (i = 2e3)),
        ...
        (V.MODULES.button = function (g) {
            ...
            function C(e) {
                ...
                return t.hasOptions && t.hasOptions.apply(g) && (f = '<div class="fr-btn-wrap">'.concat(f, " ").concat(C(e + "Options", Object.assign({}, t, { type: "options", hasOptions: !1 }), n), "  </div>")), f;
            }
            function e(o) {
                            ...
                            for (var i = "", a = "", s = 0, l = "left", c = V.TOOLBAR_VISIBLE_BUTTONS, d = 0; d < o.buttons.length; d++) {
                                ...
                                p ||
                                    ...
                                    !p ||
                                        ...
                                        (e[r].align !== undefined && (l = e[r].align), e[r].buttonsVisible !== undefined && (c = e[r].buttonsVisible), e.showMoreButtons && c <= s ? (a += C(f, p, !0)) : (i += C(f, p, !0)), s++);
                            }
            ...
            function n(e) {
                if (e.offsetWidth) {
                    ...
                    if (g || m) {
                        ...
                        t.css("width", "".concat(c.get(0).getBoundingClientRect().width - C, "px")),
                            l ||
        ...
        (V.MODULES.toolbar = function (m) {
            ...
            function n(e, t) {
                setTimeout(function () {
                    if (
                        ...
                        m.core.hasFocus() &&
                        !m.popups.areVisible() &&
                        "false" != v(m.selection.blocks()[0]).closest("table").attr("contenteditable") &&
            ...
            return {
                _init: function p() {
                    ...
                    m.opts.toolbarInline ||
                        m.opts.toolbarBottom ||
                        ((m.$second_tb = v(m.doc.createElement("div")).attr("class", "fr-second-toolbar")), m.$box.append(m.$second_tb), (!1 !== m.ul || m.opts.attribution) && m.$second_tb.prepend(V.POWERED_BY)),
                        m.opts.toolbarContainer
                            ? (m.shared.$tb
                                  ? ((m.$tb = m.shared.$tb), m.opts.toolbarInline && s())
                                  : ((m.shared.$tb = v(m.doc.createElement("DIV"))), m.shared.$tb.addClass("fr-toolbar"), (m.$tb = m.shared.$tb), v(m.opts.toolbarContainer).append(m.$tb), d(), m.$tb.data("instance", m)),
                            ...
                            : m.opts.toolbarInline
                            ? (m.$box.addClass("fr-inline"), m.shared.$tb ? ((m.$tb = m.shared.$tb), s()) : ((m.shared.$tb = v(m.doc.createElement("DIV"))), m.shared.$tb.addClass("fr-toolbar"), (m.$tb = m.shared.$tb), d()))
                            : (m.$box.addClass("fr-basic"), (m.$tb = v(m.doc.createElement("DIV"))), m.$tb.addClass("fr-toolbar"), d(), m.$tb.data("instance", m)),
