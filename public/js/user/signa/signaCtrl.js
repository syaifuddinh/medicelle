  ...
  oTable = $('#listview').DataTable({
    ...
    columns:[
      ...
      },
      {
        ...
        "<a class='btn btn-xs btn-success' href='" + baseUrl + "/signa/edit/" + resp.id +  "' title='Edit'><i class='fa fa-pencil'></i></a><a class='btn btn-xs btn-default' href='" + baseUrl + "/signa/" + resp.id +  "' title='Detail'><i class='fa fa-file-text-o'></i></a></div>"
      },
    ],
