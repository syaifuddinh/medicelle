  ...
  oTable = $('#listview').DataTable({
    ...
    columns:[
      ...
      },
      {
        ...
        "<a allow_edit_price='' class='btn btn-xs btn-success' href='" + baseUrl + "/group_user/edit/" + resp.id +  "' title='Edit'><i class='fa fa-pencil'></i></a><a allow_show_price='' class='btn btn-xs btn-default' href='" + baseUrl + "/group_user/" + resp.id +  "' title='Detail'><i class='fa fa-file-text-o'></i></a></div>"
      },
    ],
