app.controller('adjustmentStockCreate', ['$scope', '$http', '$rootScope', '$filter', '$compile', '$timeout', function($scope, $http, $rootScope, $filter, $compile, $timeout) {
    $scope.title = 'Form Stok Opname';
    $scope.data = {}
    $scope.formData = {}
    $scope.dot = '.............................................................................................................'
    $scope.shortDot = '..........'
       ...
       dom: 'rt',
        columns:[
          ...
          },
          {
            ...
            render : function(resp) {
                var index = $scope.formData.detail.length - 1
                return "<div style='height:9mm' ng-click='showLokasiModal(" + index + ", 1)'><% formData.detail[" + index + "].lokasi_name %></div>"
            }
          },
          {
            data: null, 
  ...
  lokasi_datatable = $('#lokasi_datatable').DataTable({
    ...
    $scope.reset = function() {
      ...
      adjustment_stock_detail_datatable.clear().draw()
      window.scrollTo(0, 0)
    }
    $scope.reset()
    ...
    $scope.deleteDetail = function(index, obj) {
        ...
        adjustment_stock_detail_datatable.row(row).remove().draw()
    } 


    $scope.submitForm=function() {
      $rootScope.disBtn=true;
      var url = baseUrl + '/controller/pharmacy/adjustment_stock';
      var method = 'post';
      $http[method](url, $scope.formData).then(function(data) {
        ...
        if($scope.repeat == 1) {
            if(path.indexOf('edit') > -1) {          
                setTimeout(function () {
                  window.location = baseUrl + '/pharmacy/adjustment_stock/create'          
                }, 1000)
            } else {
            ...
            setTimeout(function () {
              window.location = baseUrl + '/pharmacy/adjustment_stock'          
            }, 1000)
        }
      }, function(error) {
        $rootScope.disBtn=false;
