<?php 
 ...
 <div class="container">
        ...
        <div class="row" style='margin-top:4mm;'>
	     ...
	     <?php if($grup_nota=='Administrasi'){ ?><br>
            <div class="col-md-12" style='padding-left:5.5mm'>
		<div style='text-align:center;display:inline-block;width:100%'>--------------------------------------------------------------------------------------------------------------------------------</div>
                    <div style='border:1px solid black;padding:2mm 4mm;margin-left:750px;display:inline-block;font-size:90%'>
                        <b>COPY</b>
                    </div>
                <div class="header">
                    <div style='text-align:center;display:inline-block;width:40%'></div>
