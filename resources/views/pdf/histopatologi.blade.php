 ...
 <div class="container">
        ...
        <div class="row" style='margin-top:4mm;'>
            ...
            <div class="col-md-12" style='padding-left:5.5mm'>
                <p style='text-align:center;font-weight:bold;font-size:101%;margin-bottom:5mm'>PEMERIKSAAN HISTOPATOLOGI ANATOMI</p>
                <br>
                <br>
                <br>
                ...
                <div style='margin-top:5mm'>
                    <p style='margin-bottom:1.3mm'>DIISI OLEH PETUGAS <b>KAMAR OPERASI (OK) :</b></p>
                    <p style='margin-bottom:1mm'>
                        <span style='display:inline-block;width:40mm'>SELESAI OPERASI, PUKUL</span>
                        <span style='display:inline-block;'>:</span>
                    </p>
                    <p style='margin-bottom:1mm'>
                        <span style='display:inline-block;width:40mm'>FIKSASI FORMALIN, PUKUL</span>
                        <span style='display:inline-block;'>:</span>
                    </p>
                </div>
