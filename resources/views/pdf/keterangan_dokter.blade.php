 ...
 <div class="container">
        ...
        <div class="row" style='margin-top:4mm;'>
            ...
            <div class="col-md-12" style='padding-left:5.5mm;padding-right:8mm;line-height:1cm'>
                ...
                <p style="padding-left:8mm;text-align:justify">Berdasarkan hasil pemeriksaan pasien tersebut selama {!! $letter->age !!} hari, dari tanggal {!! Mod::fullDate($letter->start_date) !!} s/d {!! Mod::fullDate($letter->end_date) !!}, Diagnosa : {!! $letter->description !!}</p>
                <br>
