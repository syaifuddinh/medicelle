 ...
 <div class="container">
        ...
        <div class="row" style='margin-top:4mm;'>
            ...
            <div class="col-md-12" style='padding-left:5.5mm'>
                ...
                <p style='text-align:center;font-weight:bold;font-size:101%;margin-bottom:15mm'>ULTRASONOGRAPHY ( USG ) THYROID </p>
                
                <div style='margin-bottom:4mm'>
                    <p>TS. Yth, berikut saya sampaikan hasil USG Thyroid</p>
                </div>

                <div>
                    <span style="display:inline-block;width:22mm">Lobus Kanan</span>
                    <span style="display:inline-block;">:</span>
                    <span style="display:inline-block;margin-right:2mm">
                        {{ $pivotMedicalRecord->additional->usg_thyroid_lobus_kanan ?? $dot }}
                    </span>
                </div>

                <div>
                    <span style="display:inline-block;width:22mm">Lobus Kiri</span>
                    <span style="display:inline-block;">:</span>
                    <span style="display:inline-block;margin-right:2mm">
                        {{ $pivotMedicalRecord->additional->usg_thyroid_lobus_kiri ?? $dot }}
                    </span>
                </div>
