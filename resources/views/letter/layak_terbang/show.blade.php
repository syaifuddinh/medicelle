...
<!-- page content -->
<div class="right_col" role="main" id='scopeContainer' ng-controller="layakTerbangShow">
    <!-- top tiles -->
                ...
                <div class="row x_title dashboard_graph">
                    <div class="col-md-12">
                        <p>
                            ...
                            <a href="{{ route('controller.letter.layak_terbang.pdf', ['id' => $id]) }}" target="_blank">disini</a>
                        </p>
