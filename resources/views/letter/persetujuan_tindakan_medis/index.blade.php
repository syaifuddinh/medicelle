@include('header')
        ...
        <!-- page content -->
        <div class="right_col" role="main" id='scopeContainer' ng-controller="persetujuanTindakanMedis">
          <!-- top tiles -->
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="dashboard_graph">
                ...
                <div class="row x_title">
                  <div class="col-md-6">
                    <h3>Surat persetujuan tindakan medis</h3>
                  </div>
                  <div class="col-md-6">
                      <div class="btn-group pull-right export_button">
                          ...
                          @if(Auth::user()->allow_access('surat.persetujuan_tindakan_medis.create'))
                              <a href="{{ route('surat.persetujuan_tindakan_medis.create') }}" class='btn btn-success btn-sm'>Tambah</a>
                          @endif
                      </div>                    
                  </div>
                </div>
    ...
    @include('footer')
    <script src="{{ asset('') }}js/letter/persetujuan_tindakan_medis/persetujuanTindakanMedisCtrl.js"></script>
