                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">  
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <input type="text" ng-model='formData.additional.name' class='form-control'>  
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <textarea ng-model='formData.additional.address' class='form-control'></textarea>  
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <textarea ng-model='formData.additional.identitas_diri' class='form-control'></textarea>  
...
<div class="modal fade" id="medicalRecordModal" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true" >
    ...
    @include('footer')
    <script src="{{ asset('') }}js/letter/persetujuan_tindakan_medis/persetujuanTindakanMedisCreateCtrl.js"></script>
