@include('header')
        ...
        <!-- page content -->
        <div class="right_col" role="main" id='scopeContainer' ng-controller="keteranganSehat">
          <!-- top tiles -->
                ...
                <div class="row x_title">
                  ...
                  <div class="col-md-6">
                      <div class="btn-group pull-right export_button">
                          ...
                          @if(Auth::user()->allow_access('surat.keterangan_sehat.create'))
                              <a href="{{ route('surat.keterangan_sehat.create') }}" class='btn btn-success btn-sm'>Tambah</a>
                          @endif
                      </div>                    
                  </div>
                </div>
    ...
    @include('footer')
    <script src="{{ asset('') }}js/letter/keterangan_sehat/keteranganSehatCtrl.js"></script>
