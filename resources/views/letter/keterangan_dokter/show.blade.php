...
<!-- page content -->
<div class="right_col" role="main" id='scopeContainer' ng-controller="keteranganDokterShow">
    <!-- top tiles -->
                ...
                <div class="row x_title dashboard_graph">
                    <div class="col-md-12">
                        <p>
                            ...
                            <a href="{{ route('controller.letter.keterangan_dokter.pdf', ['id' => $id]) }}" target="_blank">disini</a>
                        </p>
