                                    ...
                                    <div class="col-md-12" style='display:flex'>
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" ng-model='diagnostic.reduksi' ng-value='formData.reduksi' maxlength='3' only-num>
                                                <div class="input-group-btn">
                                                    <button type='button' class='btn btn-success' ng-click='submitDiagnostic()' ng-disabled='!diagnostic.item_id'><i class="fa fa-check"></i></button>
                                                </div>
                                            </div>
