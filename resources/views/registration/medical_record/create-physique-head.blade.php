                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div style='position:relative;'>
                                            ...
                                            <img src="<% formData.additional.head_visual %>" ng-show='!is_fill_signature && formData.additional.head_visual' alt="">
                                            <img src="{{ asset('images/kepala.bmp') }}" ng-show='!is_fill_signature && !formData.additional.head_visual' alt="">
                                        </div>
                                        <div class="form-group" style='padding-bottom:7mm'>
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-md-12 col-xs-12">
                                                <trix-editor angular-trix class="form-control" ng-model='formData.head_description' ng-change='submitOne("head_description")'></trix-editor>
                                            </div>
                                        </div>
                                    </div>
                                </div>
