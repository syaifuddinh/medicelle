                    ...
                    <div class="tab-content">
                          <div id="hematologi" class="tab-pane fade in active">
                                <div class="form-group" style='padding-bottom:7mm'>
                                    ...
                                    <div class="col-md-12 col-xs-12" style='padding-bottom:4mm'>
                                        <textarea ng-model="new_research.additional.hasil_hematologi" class="form-control"></wysiwyg>
                                    </div>
                                </div>
                                <div class="form-group" style='padding-bottom:7mm'>
                                    ...
                                    <div class="col-md-12 col-xs-12" style='padding-bottom:4mm'>
                                        <textarea ng-model="new_research.additional.satuan_hematologi" class="form-control"></wysiwyg>
                                    </div>
                                </div>
                                <div class="form-group" style='padding-bottom:7mm'>
                                    ...
                                    <div class="col-md-12 col-xs-12" style='padding-bottom:4mm'>
                                        <textarea ng-model="new_research.additional.nilai_normal_hematologi" class="form-control"></wysiwyg>
                                    </div>
                                </div>
                                <div class="form-group" style='padding-bottom:7mm'>
                                    ...
                                    <div class="col-md-12 col-xs-12" style='padding-bottom:4mm'>
                                        <textarea ng-model="new_research.additional.keterangan_hematologi" class="form-control"></wysiwyg>
                                    </div>
                                </div>
                          </div>
                          ...
                          <div id="darah_lengkap" class="tab-pane fade">
                                <div class="form-group" style='padding-bottom:7mm'>
                                    ...
                                    <div class="col-md-12 col-xs-12" style='padding-bottom:4mm'>
                                        <textarea ng-model="new_research.additional.hasil_darah_lengkap" class="form-control"></wysiwyg>
                                    </div>
                                </div>
                                <div class="form-group" style='padding-bottom:7mm'>
                                    <label class="col-md-12 col-xs-12">Satuan
                                    ...
                                    <div class="col-md-12 col-xs-12" style='padding-bottom:4mm'>
                                        <textarea ng-model="new_research.additional.satuan_darah_lengkap" class="form-control"></wysiwyg>
                                    </div>
                                </div>
                                <div class="form-group" style='padding-bottom:7mm'>
                                    <label class="col-md-12 col-xs-12">Nilai normal
                                    ...
                                    <div class="col-md-12 col-xs-12" style='padding-bottom:4mm'>
                                        <textarea ng-model="new_research.additional.nilai_normal_darah_lengkap" class="form-control"></wysiwyg>
                                    </div>
                                </div>
                                <div class="form-group" style='padding-bottom:7mm'>
                                    <label class="col-md-12 col-xs-12">Keterangan
                                    ...
                                    <div class="col-md-12 col-xs-12" style='padding-bottom:4mm'>
                                        <textarea ng-model="new_research.additional.keterangan_darah_lengkap" class="form-control"></wysiwyg>
                                    </div>
                                </div>
                          </div>
                          ...
                          <div id="kimia_klinik" class="tab-pane fade">
                                <div class="form-group" style='padding-bottom:7mm'>
                                    ...
                                    <div class="col-md-12 col-xs-12" style='padding-bottom:4mm'>
                                        <textarea ng-model="new_research.additional.hasil_kimia_klinik" class="form-control"></wysiwyg>
                                    </div>
                                </div>
                                <div class="form-group" style='padding-bottom:7mm'>
                                    <label class="col-md-12 col-xs-12">Satuan
                                    ...
                                    <div class="col-md-12 col-xs-12" style='padding-bottom:4mm'>
                                        <textarea ng-model="new_research.additional.satuan_kimia_klinik" class="form-control"></wysiwyg>
                                    </div>
                                </div>
                                <div class="form-group" style='padding-bottom:7mm'>
                                    <label class="col-md-12 col-xs-12">Nilai normal
                                    ...
                                    <div class="col-md-12 col-xs-12" style='padding-bottom:4mm'>
                                        <textarea ng-model="new_research.additional.nilai_normal_kimia_klinik" class="form-control"></wysiwyg>
                                    </div>
                                </div>
                                <div class="form-group" style='padding-bottom:7mm'>
                                    <label class="col-md-12 col-xs-12">Keterangan
                                    ...
                                    <div class="col-md-12 col-xs-12" style='padding-bottom:4mm'>
                                        <textarea ng-model="new_research.additional.keterangan_kimia_klinik" class="form-control"></wysiwyg>
                                    </div>
                                </div>
                          </div>
                          ...
                          <div id="imuno" class="tab-pane fade">
                                <div class="form-group" style='padding-bottom:7mm'>
                                    ...
                                    <div class="col-md-12 col-xs-12" style='padding-bottom:4mm'>
                                        <textarea ng-model="new_research.additional.hasil_umuno" class="form-control"></wysiwyg>
                                    </div>
                                </div>
                                <div class="form-group" style='padding-bottom:7mm'>
                                    <label class="col-md-12 col-xs-12">Satuan
                                    ...
                                    <div class="col-md-12 col-xs-12" style='padding-bottom:4mm'>
                                        <textarea ng-model="new_research.additional.satuan_umuno" class="form-control"></wysiwyg>
                                    </div>
                                </div>
                                <div class="form-group" style='padding-bottom:7mm'>
                                    <label class="col-md-12 col-xs-12">Nilai normal
                                    ...
                                    <div class="col-md-12 col-xs-12" style='padding-bottom:4mm'>
                                        <textarea ng-model="new_research.additional.nilai_normal_umuno" class="form-control"></wysiwyg>
                                    </div>
                                </div>
                                <div class="form-group" style='padding-bottom:7mm'>
                                    <label class="col-md-12 col-xs-12">Keterangan
                                    ...
                                    <div class="col-md-12 col-xs-12" style='padding-bottom:4mm'>
                                        <textarea ng-model="new_research.additional.keterangan_umuno" class="form-control"></wysiwyg>
                                    </div>
                                </div>
                          </div>
                    </div>
