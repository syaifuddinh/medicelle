...
@include('registration/medical_record/create-physique-header')
                        ...
                        <div id='role_layer' style="position:relative">
                                @if(Specialization::readonly('rectum') == 1)
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div style='position:relative;'>
                                            ...
                                            <img src="<% formData.additional.rectum_visual %>" ng-show='!is_fill_signature && formData.additional.rectum_visual' alt="">
                                            <img src="{{ asset('images/rectum.bmp') }}" ng-show='!is_fill_signature && !formData.additional.rectum_visual' alt="">
                                        </div>
                                        <div class="form-group" style='padding-bottom:7mm'>
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-md-12 col-xs-12">
                                                <wysiwyg ng-model='formData.rectum_description' ng-change='submitOne("rectum_description")'></wysiwyg>
                                            </div>
                                        </div>
                                    </div>
                                </div>
