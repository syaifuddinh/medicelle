                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8 col-sm-8 col-xs-12">
                                                <textarea  ng-model='formData.additional.medical_checkup_general_condition' class="form-control col-md-12 col-xs-12" ng-change='submitOne("additional.medical_checkup_general_condition")'></wysiwyg>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-md-12 col-xs-12">
                                                <wysiwyg ng-model='formData.additional.medical_checkup_pemeriksaan_penunjang' ng-change='submitOne("additional.medical_checkup_pemeriksaan_penunjang")'></wysiwyg>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-md-12 col-xs-12">
                                                <wysiwyg ng-model='formData.additional.medical_checkup_kesimpulan' ng-change='submitOne("additional.medical_checkup_kesimpulan")'></wysiwyg>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-md-12 col-xs-12">
                                                <wysiwyg ng-model='formData.additional.medical_checkup_saran' ng-change='submitOne("additional.medical_checkup_saran")'></wysiwyg>
                                            </div>
                                        </div>
                                    </div>
                                </div>
