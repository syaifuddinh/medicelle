                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8 col-sm-8 col-xs-12">
                                                <trix-editor angular-trix class="form-control" ng-model='formData.main_complaint' ng-mouseleave="submitOne('main_complaint')"></trix-editor>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8 col-sm-8 col-xs-12">
                                                <trix-editor angular-trix class="form-control" ng-model='formData.current_disease'  ng-mouseleave="submitOne('current_disease')"></trix-editor>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8 col-sm-8 col-xs-12">
                                                <trix-editor angular-trix class="form-control" ng-model='formData.additional.riwayat_penyakit_dahulu' ng-mouseleave='submitOne("additional.riwayat_penyakit_dahulu")'></trix-editor>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8 col-sm-8 col-xs-12">
                                                    <trix-editor angular-trix class="form-control" ng-model='formData.cure_history'  ng-mouseleave="submitOne('cure_history')"></trix-editor>
                                                </div>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8 col-sm-8 col-xs-12">
                                                    <trix-editor angular-trix class="form-control" ng-model='formData.allergy_history'  ng-mouseleave="submitOne('allergy_history')"></trix-editor>
                                                </div>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8 col-sm-8 col-xs-12">
                                                    <trix-editor angular-trix class="form-control" ng-model='formData.family_disease_history'  ng-mouseleave="submitOne('family_disease_history')"></trix-editor>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8 col-sm-8 col-xs-12">
                                                    <trix-editor angular-trix class="form-control" ng-model='formData.psiko_sosial'  ng-mouseleave="submitOne('psiko_sosial')"></trix-editor>
                                                </div>
                                            </div>
