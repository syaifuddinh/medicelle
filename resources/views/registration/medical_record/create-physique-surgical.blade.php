...
@include('registration/medical_record/create-physique-header')
                        ...
                        <div id='role_layer' style="position:relative">
                                @if(Specialization::readonly('surgical') == 1)
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div style='position:relative;'>
                                            ...
                                            <img src="<% formData.additional.surgical_visual %>" ng-show='!is_fill_signature && formData.additional.surgical_visual' alt="">
                                            <img src="{{ asset('images/general.bmp') }}" ng-show='!is_fill_signature && !formData.additional.surgical_visual' alt="">
                                        </div>
