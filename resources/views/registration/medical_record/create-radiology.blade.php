@include('registration/medical_record/create-header')
                        ...
                        <div id='role_layer' style="position:relative">
                            ...
                            <ul class="nav nav-tabs">
                                ...
                                <li><a data-toggle="tab" href="#semua">Semua</a></li>
                            </ul>
                            ...
                            <div class="tab-content">
								<div id="eksternal" class="tab-pane fade in active">
                                    <div class="" style='padding-top:10mm'>
                                        <div class="row">
											...
											<div class="col-md-12" style='display:flex'>
												<div class="form-group col-md-6">
													<button type='button' class='btn btn-sm btn-success submitButton' ng-click='submitResearch("radiology")' ng-disabled='!research.name || disBtn'><i class="fa fa-check"></i></button> 
												</div>
											</div>
										</div>
								...
								<div id="semua" class="tab-pane fade">
									<div class="" style='padding-top:10mm'>
										<div class="row" style='margin-top:4mm'>
											<div class="col-md-12">
												<table class="table table-bordered" id='radmerge_datatable'>
													<thead>
													<tr>
														<td>Tanggal pemeriksaan</td>
														<td>Jenis pemeriksaan</td>
                                    ...
                                    <div style='padding-top:10mm'>
                                        <table class="table table-bordered" id='intmerge_radiology_datatable'>
                                            <thead>
                                            <tr>
                                                <td>Tanggal pemeriksaan</td>
                                                <td>Jenis pemeriksaan</td>
...
<div class="modal fade" id="newResearchModal" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true" >
                ...
                <form>
                    <div class="form-group" style='padding-bottom:7mm'>
                        ...
                        <div class="col-md-12 col-xs-12" style='padding-bottom:4mm'>
                            <trix-editor angular-trix ng-model="new_research.kanan" class="form-control"></trix-editor>
                        </div>
                    </div>
                    <div class="form-group" style='padding-bottom:7mm'>
                        ...
                        <div class="col-md-12 col-xs-12" style='padding-bottom:4mm'>
                            <trix-editor angular-trix ng-model="new_research.kiri" class="form-control"></trix-editor>
                        </div>
                    </div>
                    <div class="form-group" style='padding-bottom:7mm'>
                        ...
                        <div class="col-md-12 col-xs-12" style='padding-bottom:4mm'>
                            <trix-editor angular-trix ng-model="new_research.kesimpulan" class="form-control"></trix-editor>
                        </div>
                    </div>
                    <div class="form-group" style='padding-bottom:7mm'>
                        ...
                        <div class="col-md-12 col-xs-12" style='padding-bottom:4mm'>
                            <trix-editor angular-trix ng-model="new_research.saran" class="form-control"></trix-editor>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="picRadiologyModal" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true" >
        <div class="modal-dialog" style='width:80%'>
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <table class="table table-striped" id='pj_radiology_datatable' style='width:100%'>
                        <thead>
                            <tr>
                                <th>Nama</th>
                                <th></th>
