                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <trix-editor angular-trix  ng-model='formData.additional.riwayat_vaksinasi' class="form-control col-md-7 col-xs-12" ng-change='submitOne("additional.riwayat_vaksinasi")'></trix-editor>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <trix-editor angular-trix  ng-model='formData.additional.papsmear_kontrasepsi' class="form-control col-md-7 col-xs-12" ng-change='submitOne("additional.papsmear_kontrasepsi")'></trix-editor>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <trix-editor angular-trix  ng-model='formData.additional.obgyn_papsmear' class="form-control col-md-7 col-xs-12" ng-change='submitOne("additional.obgyn_papsmear")'></trix-editor>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <trix-editor angular-trix  ng-model='formData.additional.papsmear_keluhan' class="form-control col-md-7 col-xs-12" ng-change='submitOne("additional.papsmear_keluhan")'></trix-editor>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <trix-editor angular-trix  ng-model='formData.additional.papsmear_jumlah_slide' class="form-control col-md-7 col-xs-12" ng-change='submitOne("additional.papsmear_jumlah_slide")'></trix-editor>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <trix-editor angular-trix  ng-model='formData.additional.papsmear_lokasi' class="form-control col-md-7 col-xs-12" ng-change='submitOne("additional.papsmear_lokasi")'></trix-editor>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <trix-editor angular-trix  ng-model='formData.additional.papsmear_cervix' class="form-control col-md-7 col-xs-12" ng-change='submitOne("additional.papsmear_cervix")'></trix-editor>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <trix-editor angular-trix  ng-model='formData.additional.papsmear_description' class="form-control col-md-7 col-xs-12" ng-change='submitOne("additional.papsmear_description")'></trix-editor>
                                            </div>
                                        </div>
