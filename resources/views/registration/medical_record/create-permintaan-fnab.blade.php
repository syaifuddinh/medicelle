                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8 col-sm-8 col-xs-12">
                                                <trix-editor angular-trix  ng-model='formData.additional.fnab_diagnose' class="form-control col-md-7 col-xs-12" ng-change='submitOne("additional.fnab_diagnose")'></trix-editor>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div style='position:relative;'>
                                            ...
                                            <img src="<% formData.additional.fnab_visual %>" ng-show='!is_fill_signature && formData.additional.fnab_visual' alt="">
                                            <img src="{{ asset('images/fnab.png') }}" ng-show='!is_fill_signature && !formData.additional.fnab_visual' alt="">
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8 col-sm-8 col-xs-12">
                                                <trix-editor angular-trix  ng-model='formData.additional.fnab_description' class="form-control col-md-7 col-xs-12" ng-change='submitOne("additional.fnab_description")'></trix-editor>
                                            </div>
                                        </div>
