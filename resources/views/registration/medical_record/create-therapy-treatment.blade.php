                        ...
                        <div class="row">
                            <div class="col-md-12" style='display:flex'>
                                ...
                                <div class="form-group col-md-3 mg-r2">
                                    ...
                                    <select class="form-control" data-placeholder-text-single="'Pilih tindakan / jenis pemeriksaan'" chosen allow-single-deselect="false" ng-model="treatment.item_id" ng-options="c.id as c.name group by c.province.name for c in data.treatment">
                                        <option value=""></option>
                                    </select>
                                </div>
                                <div class="form-group col-md-3 mg-r2">
                                ...
                                <div class="form-group col-md-4 mg-r2">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-btn">
                                            <button type='button' class='btn btn-success' ng-click='submitTreatment()' disabled='!treatment.item_id'>Tambah</button>
                                        </div>
                                    </div>
