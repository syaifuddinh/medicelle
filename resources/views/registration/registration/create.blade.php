      ...
      <div class="dashboard_graph">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="col-md-6">
              ...
              <span ng-show='formData.patient_type == "ASURANSI SWASTA"'>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-10 col-xs-12">
                      <select class="form-control" data-placeholder-text-single="'Pilih instansi / asuransi'" required='required' chosen allow-single-deselect="false" ng-model="formData.agency_id" ng-options="c.id as c.name for c in data.agency" ng-disabled='!is_new_patient'>
                          <option value=""></option>
                      </select>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-10 col-xs-12">
                        <input type="text" ng-model="formData.plafon" class="form-control">
                    </div>
                  </div>
              </span>
          ...
          <div class="row">
              ...
              <div class="col-md-4" ng-show='detail.destination == "POLIKLINIK"'>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <div class="input-group-btn">
                              <button type='button' class='btn btn-success' ng-click='submitDetail()'>Tambah</button>
                          </div>
                      </div>
