                    ...
                    <div class="col-md-8">
                        <span class='pull-right' ng-show='formData.registration_id'>
                            ...
                            <a href='#' class='btn btn-sm btn-info'>
                                <i class='fa fa-user'></i> <% registration.patient.name %>
                            </a>
                            ...
                            <a href='#' class='btn btn-sm btn-dark'>
                                ...
                                <% registration.medical_record.code %>
                            </a>
                        </span>
                    </div>
                </div>
                    ...
                    >
                            ...
                            <h2 class="d-flex justify-content-between">
                                ...
                                <div class="d-inline-block">
                                    <button
                                        ...
                                        ng-click='insertFromOtherInvoice()'
                                    >
                                        Tambah dari invoice lain
                                    </button>
                                ...
                                <table class='table' id='invoice_detail_datatable'>
                                        ...
                                        <tr>
                                            ...
                                            <th  style='width:20%'>
                                                ...
                                                <button
                                                    type='button'
                                                    id='asuransi_flag'
                                                    style='margin-left:2mm'
                                                    class='btn btn-xs btn-primary'
                                                    ng-show='formData.payment_type == "ASURANSI SWASTA"'
                                                >
                                                    <i class='fa fa-arrow-up'></i> 
                                                    {{ Mod::finance()->asuransi_rate_percentage ?? 0 }}%
                                                </button>
                                            </th>
                                        </tr>
                                    </thead>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <th class='text-right' title='Total tagihan yang harus dibayar'>
                                                <% grosstotal | number%>        
                                            </th>
                                        </tr>
                                        <tr>
                                            ...
                                            <th
                                                class='text-right'
                                                title='Diskon untuk seluruh item'
                                            >
                                                <input
                                                    type="text"
                                                    class='form-control'
                                                    ng-model='formData.massive_discount'
                                        ...
                                        <tr>
                                            ...
                                            <th
                                                colspan='3'
                                                class='text-right'
                                                style='padding-top:4mm'
                                            >
                                                <span>Promo</span>
                                                <span ng-show='formData.discount_id'>
                                                    <br>
                                                    <% promo_name %>
                                                </span>
                                            </th>
                        ...
                        <div class="row" id='formFooter'>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label class="col-md-12 col-xs-12" for="first-name">
                                        Jenis
                                        <span class="required">*</span>
                                    </label>
                                    ...
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        <label class='radio-inline'>
                                            <input
                                                type="radio"
                                                ng-model='formData.payment_type'
                                                name='payment_type'
                                                ng-value="'BAYAR SENDIRI'"
                                                ng-change='countTotal()'
                                            > Bayar sendiri
                                        </label>
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-12 col-md-offset-1">
                                <div class="btn-group" id='button-container'>
                                    ...
                                    <button
                                        type="button"
                                        id='payButton'
                                        ng-disabled='grandtotal > formData.paid'
                                        ng-click='pay = 1;'
                                        ng-disabled='disBtn'
        ...
        <div class="modal-dialog" style='width:80%'>
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="">Daftar Invoice</h4>
                </div>
                <div class="modal-body">
                    <table
                        class="table table-bordered"
                        id='invoice_datatable'
                        style='width:100%'
                    >
                        <thead>
                            <tr>
