...
<!-- page content -->
<div class="right_col" role="main" id='scopeContainer' ng-controller="polyclinicCreate" ng-cloak>
    <!-- top tiles -->
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="dashboard_graph">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <table class="table table-bordered" id='polyclinic_detail_datatable'>
                                <thead>
                                    <tr>
                                        <td>Tujuan</td>
                                        <td>Waktu</td>
...
@include('footer')
<script src="{{ asset('') }}js/polyclinic/polyclinic/polyclinicCreateCtrl.js"></script>
