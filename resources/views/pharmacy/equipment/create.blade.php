...
<!-- page content -->
<div class="right_col" role="main" id='scopeContainer' ng-controller="equipmentCreate" ng-cloak>
    <!-- top tiles -->
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <table class="table table-bordered table-hover" id='equipment_detail_datatable'>
                                <thead>
                                    <tr>
                                        <td>Barang</td>
                                        <td>Lokasi</td>
                                        <td style='width:12mm'>Jumlah Penggunaan</td>
...
@include('footer')
<script src="{{ asset('') }}js/pharmacy/equipment/equipmentCreateCtrl.js"></script>
