@include('header')
        ...
        <!-- page content -->
        <div class="right_col" role="main" id='scopeContainer' ng-controller="equipment">
          <!-- top tiles -->
                ...
                <div class="row x_title">
                  ...
                  <div class="col-md-6">
                      <div class="btn-group pull-right export_button">
                          ...
                          <a href="{{ route('pharmacy.equipment.create') }}" class='btn btn-success btn-sm'>Tambah</a>
                      </div>                    
                  </div>
                </div>
    ...
    @include('footer')
    <script src="{{ asset('') }}js/pharmacy/equipment/equipmentCtrl.js"></script>
