                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        <div class="input-daterange input-group" style="width:100%;">
                                            <input type="text" class="input-sm form-control" ng-model="formData.date_start" ng-change='changeStock()' datepick/>
                                            <span class="input-group-addon">s/d</span>
                                            <input type="text" class="input-sm form-control" ng-model="formData.date_end" ng-change='changeStock()' datepick />
                                          </div>
                                    </div>
                                </div>
                                <div class="form-group">
