        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="dashboard_graph">
                ...
                <div class="row x_title">
                    ...
                    <div class="col-md-6">
                        <div class="btn-group pull-right">
                            @if(Auth::user()->allow_access('purchaseRequest.edit'))
                                <a ng-if='formData.status == 1' href='{{ route("purchaseRequest.edit", ["id" => $id]) }}' class="btn btn-warning btn-sm" >Edit</a>
                            @endif
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <table class="table table-bordered" id='purchaseRequest_detail_datatable'>
                                <thead>
                                    <tr>
                                        <td>Tujuan</td>
                                        <td>Waktu</td>
