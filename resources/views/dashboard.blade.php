                                    ...
                                    <table class="table no-wrap v-middle">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="d-flex no-block align-items-center">
                                                        <div class="mr-2"><img src="{{ asset('public/assets/images/users/d1.jpg') }}" alt="user" class="rounded-circle" width="45" /></div>
                                                        <div class="">
                                                ...
                                                <td>
                                                    <div class="popover-icon">
                                                        ...
                                                        <a class="btn-circle btn p-0 popover-item" href="javascript:void(0)"><img src="{{ asset('public/assets/images/users/1.jpg') }}" class="rounded-circle" width="39" alt="" /></a>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex no-block align-items-center">
                                                        <div class="mr-2"><img src="{{ asset('public/assets/images/users/d2.jpg') }}" alt="user" class="rounded-circle" width="45" /></div>
                                                        <div class="">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex no-block align-items-center">
                                                        <div class="mr-2"><img src="{{ asset('public/assets/images/users/d3.jpg') }}" alt="user" class="rounded-circle" width="45" /></div>
                                                        <div class="">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex no-block align-items-center">
                                                        <div class="mr-2"><img src="{{ asset('public/assets/images/users/2.jpg') }}" alt="user" class="rounded-circle" width="45" /></div>
                                                        <div class="">
                        ...
                        <div class="card">
                            ...
                            <div class="comment-widgets scrollable" style="height:560px;">
                                ...
                                <div class="d-flex flex-row comment-row mt-0">
                                    <div class="p-2"><img src="{{ asset('public/assets/images/users/1.jpg') }}" alt="user" width="50" class="rounded-circle"></div>
                                ...
                                <div class="d-flex flex-row comment-row">
                                    <div class="p-2"><img src="{{ asset('public/assets/images/users/4.jpg') }}" alt="user" width="50" class="rounded-circle"></div>
                                ...
                                <!-- Comment Row -->
                                <div class="d-flex flex-row comment-row">
                                    <div class="p-2"><img src="{{ asset('public/assets/images/users/5.jpg') }}" alt="user" width="50" class="rounded-circle"></div>
                                    <div class="comment-text w-100">
