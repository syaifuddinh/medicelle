...
<!-- page content -->
<div class="right_col" role="main" id='scopeContainer' ng-controller="nurseShow">
    <!-- top tiles -->
                    ...
                    <div class="col-md-6">
                        <div class="btn-group pull-right">
                            @if(Auth::user()->allow_access('master.medical_worker.edit'))
                                <a href='{{ route("nurse.edit", ["id" => $id]) }}' class="btn btn-warning btn-sm" >Edit</a>
                            @endif
...
@include('footer')
<script src="{{ asset('') }}js/master/nurse/nurseShowCtrl.js"></script>
