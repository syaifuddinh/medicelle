@include('header')
        ...
        <!-- page content -->
        <div class="right_col" role="main" id='scopeContainer' ng-controller="nurse">
          <!-- top tiles -->
          <nav style='margin-bottom:2mm'>
            
             <ul class="nav nav-pills">
                <li><a href="{{ route('doctor.index') }}">Dokter</a></li>
                <li class="active"><a href="{{ route('nurse.index') }}">Medis</a></li>
...
<label class="radio-inline">
                  ...
                  <div class="col-md-6">
                      <div class="btn-group pull-right export_button">
                          ...
                          @if(Auth::user()->allow_access('master.medical_worker.create'))
                              <a href="{{ route('nurse.create') }}" class='btn btn-success btn-sm'>Tambah</a>
                          @endif
                      </div>                    
                  </div>
                </div>
    ...
    @include('footer')
    <script src="{{ asset('') }}js/master/nurse/nurseCtrl.js"></script>
