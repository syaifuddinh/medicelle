...
<!-- page content -->
<div class="right_col" role="main" id='scopeContainer' ng-controller="nurse_helperCreate" ng-cloak>
    <!-- top tiles -->
...
@include('footer')
<script src="{{ asset('') }}js/master/nurse_helper/nurseHelperCreateCtrl.js"></script>
