@include('header')
        ...
        <!-- page content -->
        <div class="right_col" role="main" id='scopeContainer' ng-controller="polyclinicCreate">
          <!-- top tiles -->
              ...
              <div class="dashboard_graph">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" ng-submit='submitForm()'>
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Index
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first-name" ng-model='formData.index' jnumber2 only-num class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                     
                     
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Cost center
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first-name" ng-model='formData.cost_center'  class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
    ...
    @include('footer')
    <script src="{{ asset('') }}js/master/polyclinic/polyclinicCreateCtrl.js"></script>
