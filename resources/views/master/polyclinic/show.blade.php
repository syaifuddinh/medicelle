@include('header')
              ...
              <div class="dashboard_graph">
                ...
                <div class="row x_title">
                  ...
                  <div class="col-md-6">
                      <div class="btn-group pull-right">
                          ...
                          <a href='{{ route("polyclinic.edit", ["id" => $id]) }}' class="btn btn-warning btn-sm" >Edit</a>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" ng-submit='submitForm()'>
                      ...
                      <div class="form-group">
                        <label class="col-md-2 col-sm-2 col-xs-12" for="first-name">Index
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <% formData.index %>
                        </div>
                      ...
                      <div class="form-group">
                        <label class="col-md-2 col-sm-2 col-xs-12" for="first-name">Cost Center
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
    ...
    @include('footer')
    <script src="{{ asset('') }}js/master/polyclinic/polyclinicShowCtrl.js"></script>
