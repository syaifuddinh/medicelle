@include('header')
        ...
        <!-- page content -->
        <div class="right_col" role="main" id='scopeContainer' ng-controller="agencyShow">
          <!-- top tiles -->
              ...
              <div class="dashboard_graph">
                  ...
                  <div class="col-md-6">
                      <div class="btn-group pull-right">
                          @if(Auth::user()->allow_access('master.supplier.edit'))                          
                              <a href='{{ route("agency.edit", ["id" => $id]) }}' class="btn btn-warning btn-sm" >Edit</a>
                          @endif
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" ng-submit='submitForm()'>
                      ...
                      <div class="form-group">
                        <label class="col-md-2 col-sm-2 col-xs-12" for="first-name">Jenis
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <% formData.agency_disc_percent || 0 %>% 
                        </div>
                      </div>
    ...
    @include('footer')
    <script src="{{ asset('') }}js/master/agency/agencyShowCtrl.js"></script>
