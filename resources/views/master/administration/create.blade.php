...
<!-- page content -->
<div class="right_col" role="main" id='scopeContainer' ng-controller="administrationCreate" ng-cloak>
  <!-- top tiles -->
  ...
  @include('footer')
  <script src="{{ asset('') }}js/master/administration/administrationCreateCtrl.js"></script>
