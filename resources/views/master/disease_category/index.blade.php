@include('header')
        ...
        <!-- page content -->
        <div class="right_col" role="main" id='scopeContainer' ng-controller="disease_category">
          <!-- top tiles -->
          <nav style='margin-bottom:2mm'>
            
             <ul class="nav nav-pills">
                <li><a href="{{ route('disease.index') }}">Penyakit</a></li>
                <li class="active"><a href="{{ route('disease_category.index') }}">Kategori penyakit</a></li>
              </ul> 
          </nav>
                ...
                <div class="row x_title">
                  ...
                  <div class="col-md-6">
                      <div class="btn-group pull-right export_button">
                          ...
                          @if(Auth::user()->allow_access('master.disease.create'))
                              <a href="{{ route('disease_category.create') }}" class='btn btn-success btn-sm'>Tambah</a>
                          @endif
                      </div>                    
                  </div>
                </div>
