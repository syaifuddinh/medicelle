@include('header')
        ...
        <!-- page content -->
        <div class="right_col" role="main" id='scopeContainer' ng-controller="supplier">
          <!-- top tiles -->
          <nav style='margin-bottom:2mm'>
            
             <ul class="nav nav-pills">
                <li class="active"><a href="{{ route('supplier.index') }}">Distributor Farmasi</a></li>
                <li><a href="{{ route('agency.index') }}">Asuransi & instansi</a></li>
              </ul> 
          </nav>
...
<label class="radio-inline">
                  ...
                  <div class="col-md-6">
                      <div class="btn-group pull-right export_button">
                          ...
                          @if(Auth::user()->allow_access('master.supplier.create'))
                              <a href="{{ route('supplier.create') }}" class='btn btn-success btn-sm'>Tambah</a>
                          @endif
                      </div>                    
                  </div>
                </div>
    ...
    @include('footer')
    <script src="{{ asset('') }}js/master/supplier/supplierCtrl.js"></script>
