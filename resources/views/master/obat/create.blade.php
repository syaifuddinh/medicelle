...
<!-- page content -->
<div class="right_col" role="main" id='scopeContainer' ng-controller="obatCreate" ng-cloak>
  <!-- top tiles -->
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
          <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" ng-submit='submitForm()'>
            <div class="row">
             <div class="col-md-6">
              ...
              <div class="form-group" ng-show='is_allow_subclassification == 1'>
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Sub-Kelas<span class="required">*</span>
                </label>
                <div class="col-md-8 col-sm-8 col-xs-12">
                <div class="input-group">
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Tanggal kadaluarsa
                </label>
                <div class="col-md-8 col-sm-8 col-xs-12">
                  <input type="text" id="first-name" ng-model='formData.additional.expired_date' class="form-control col-md-7 col-xs-12" datepick>
                </div>
              </div>
