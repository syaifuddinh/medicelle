@include('header')
        ...
        <!-- page content -->
        <div class="right_col" role="main" id='scopeContainer' ng-controller="pieceShow">
          <!-- top tiles -->
                ...
                <div class="row x_title">
                  ...
                  <div class="col-md-6">
                      <div class="btn-group pull-right">
                          ...
                          <a href='{{ route("piece.edit", ["id" => $id]) }}' class="btn btn-warning btn-sm" >Edit</a>
    ...
    @include('footer')
    <script src="{{ asset('') }}js/master/piece/pieceShowCtrl.js"></script>
