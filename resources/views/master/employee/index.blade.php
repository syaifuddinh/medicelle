@include('header')
        ...
        <!-- page content -->
        <div class="right_col" role="main" id='scopeContainer' ng-controller="employee">
          <!-- top tiles -->
...
<label class="radio-inline">
                ...
                <div class="row x_title">
                  ...
                  <div class="col-md-6">
                      <div class="btn-group pull-right export_button">
                          ...
                          @if(Auth::user()->allow_access('master.employee.create'))
    ...
    @include('footer')
    <script src="{{ asset('') }}js/master/employee/employeeCtrl.js"></script>
