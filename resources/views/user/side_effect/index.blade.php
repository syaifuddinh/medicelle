@include('header')
        ...
        <!-- page content -->
        <div class="right_col" role="main" id='scopeContainer' ng-controller="sideEffect">
          <!-- top tiles -->
                ...
                <div class="row x_title">
                  ...
                  <div class="col-md-4">
                      <div class="col-md-11 btn-group pull-right export_button">
                          ...
                          @if(Auth::user()->allow_access('setting.side_effect.create'))
                              <a href="{{ route('side_effect.create') }}" style='width:37%' class='btn btn-success btn-sm'>Tambah</a>
                          @endif
                      </div>                    
                  </div>
                </div>
    ...
    @include('footer')
    <script src="{{ asset('') }}js/user/side_effect/sideEffectCtrl.js"></script>
