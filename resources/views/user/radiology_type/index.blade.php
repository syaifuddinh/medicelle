@include('header')
        ...
        <!-- page content -->
        <div class="right_col" role="main" id='scopeContainer' ng-controller="radiologyType">
          <!-- top tiles -->
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="dashboard_graph">
                ...
                <div class="row x_title">
                  <div class="col-md-8">
                    <h3>Jenis pemeriksaan radiologi</h3>
                  </div>
                  <div class="col-md-4">
                      <div class="col-md-11 btn-group pull-right export_button">
                          ...
                          @if(Auth::user()->allow_access('setting.radiology_type.create'))
                              <a href="{{ route('radiology_type.create') }}" style='width:37%' class='btn btn-success btn-sm'>Tambah</a>
                          @endif
                      </div>                    
                  </div>
                </div>
    ...
    @include('footer')
    <script src="{{ asset('') }}js/user/radiology_type/radiologyTypeCtrl.js"></script>
