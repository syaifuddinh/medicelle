@include('header')
        ...
        <!-- page content -->
        <div class="right_col" role="main" id='scopeContainer' ng-controller="grupNotaCreate">
          <!-- top tiles -->
                  ...
                  <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" ng-submit='submitForm()'>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first-name" ng-model='formData.slug' required="required" class="form-control col-md-7 col-xs-12" autofocus>
                        </div>
                      </div>
    ...
    @include('footer')
    <script src="{{ asset('') }}js/user/grup_nota/grupNotaCreateCtrl.js"></script>
